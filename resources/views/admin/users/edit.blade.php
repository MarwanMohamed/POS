...
<div class="panel">
    <div class="panel-body">
        <h3 class="title-hero">{{trans('employees.edit_user')}}</h3>
                ...
                <div class="form-group{{ $errors->has('date') ? ' has-error' : '' }}  @if(Session::has('error')) has-error @endif">
                    ...
                    <div class="col-sm-6">
                        <div class="input-prepend input-group">
                            ...
                            <input type="text" class="bootstrap-datepicker form-control" value="{{old('date', $user->date)}}" name="date" data-date-format="yy">
                        </div>
                            <span class="help-block">
                ...
                <div class="form-group{{ $errors->has('branch_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        <select name="branch_id" class="chosen-select" style="display: none;">
                            ...
                            <option value="{{$branch->id}}" @if($user->branch->name == $branch->name) selected @endif>{{$branch->name}}</option>
                            @endforeach
                        </select>
